...
let UserResolver = class UserResolver {
    ...
    login({ req }, user) {
        return __awaiter(this, void 0, void 0, function* () {
            const _userFound = yield User_1.User.findOne({
    ...
    resetPassword(emailInput, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield User_1.User.findOne({ id: Number.parseInt(userId) });
            if (user) {
                yield User_1.User.update({ id: Number.parseInt(userId) }, {
                    password: hashed,
                });
            }
